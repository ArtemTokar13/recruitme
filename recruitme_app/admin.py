...
class UserAdmin(BaseUserAdmin):
    ...
    fieldsets = (
        ...
        ('User dates', {'fields': ('registration_date',)}),
...
admin.site.register(UserProfile, UserAdmin) # Register the new UserAdmin...
admin.site.register(WorkerProfile)
admin.site.register(JobProfile)
admin.site.register(Apply)
admin.site.register(SkillTag)
admin.site.register(Requirements)
admin.site.unregister(Group) # ... and, since we're not using Django's built-in permissions, unregister the Group model from admin.
